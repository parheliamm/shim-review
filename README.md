...
-------------------------------------------------------------------------------
Yes, we are using shim 15.6 release tarball
https://github.com/rhboot/shim/releases/download/15.6/shim-15.6.tar.bz2

-------------------------------------------------------------------------------
### URL for a repo that contains the exact code which was built to get this binary:
-------------------------------------------------------------------------------
Our build service isn't publicly available. The code is shim 15.4 + the patches described below and added here
...
- shim-change-debug-file-path.patch: Change the default debug file path
- shim-bsc1177315-verify-eku-codesign.patch: Verify CodeSign in the signer's EKU
- shim-bsc1177789-fix-null-pointer-deref-AuthenticodeVerify.patch: Fix the NULL pointer dereference in AuthenticodeVerify()
- remove_build_id.patch: Remove the build ID to make the binary reproducible when building with AArch64 container
- shim-disable-export-vendor-dbx.patch: Disable exporting vendor-dbx to MokListXRT
